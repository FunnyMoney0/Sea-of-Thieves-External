...
namespace offsets
{
	...
	//DrowningComponent
	OFFSET(DrowningComponent, 0xd98);//AActor Drowning Component
	...
	OFFSET(ProjectileGravityScale, 0x5c0);
	OFFSET(ProjectileSpeed, 0x5bc);
	OFFSET(ServerPitch, 0x7b8);
	OFFSET(ServerYaw, 0x7bc);
