...
namespace cheat
{
	...
	constexpr const ImColor _svn_color{ 0.51f, 1.0f, 0.38f };
	...
	const std::unordered_map<SOT::ActorType, const ActorESPInfo> _creature_esp_info
	{
        ...
        { SOT::ActorType::OCEAN_CRAWLER_CRAB,	ActorESPInfo{ "[Crab Ocean Crawler]", _creature_color } },
        { SOT::ActorType::OCEAN_CRAWLER_HERMIT,	ActorESPInfo{ "[Hermit Ocean Crawler]", _creature_color } },
        { SOT::ActorType::TINY_SHARK,			ActorESPInfo{ "[Megalodon]", _creature_color } },
	...
	const std::unordered_map<SOT::ActorType, const ActorESPInfo> _treasure_esp_info
	{
        ...
        { SOT::ActorType::TREASURE_CHEST_CM_DVR,            ActorESPInfo{ "[Ashen Castaway's Chest]", _treasure_color } },
        ...
        { SOT::ActorType::MCH_CRATE_COMMODITY_GHOST_CRATE,  ActorESPInfo{ "[Ashes of the Damned]", _treasure_color } },
        ...
        { SOT::ActorType::DRUNKEN_TREASURE_CHEST,           ActorESPInfo{ "[Chest of a Thousand Grogs]", _treasure_color } },
        { SOT::ActorType::GHOST_TREASURE_CHEST,             ActorESPInfo{ "[Chest of the Damned]", _treasure_color } },
        { SOT::ActorType::CORAL_MESSAGE_IN_A_BOTTLE,        ActorESPInfo{ "[Coral Message in a Bottle]", _treasure_color } },
        { SOT::ActorType::MCH_CRATE_COMMODITY_FORT,         ActorESPInfo{ "[Crate of Ancient Bone Dust]", _treasure_color } },
        { SOT::ActorType::MCH_CRATE_COMMODITY_SILK_CRATE,   ActorESPInfo{ "[Crate of Exotic Silks]", _treasure_color } },
        { SOT::ActorType::MCH_COMMODITY_SPICE_CRATE,        ActorESPInfo{ "[Crate of Exquisite Spices]", _treasure_color } },
        { SOT::ActorType::MCH_CRATE_COMMODITY_MINERALS,		ActorESPInfo{ "[Crate of Extraordinary Minerals]", _treasure_color } },
        { SOT::ActorType::MCH_CRATE_COMMODITY_ORE,          ActorESPInfo{ "[Crate of Fine Ore]", _treasure_color } },
        { SOT::ActorType::MCH_CRATE_COMMODITY_SUGAR_CRATE,  ActorESPInfo{ "[Crate of Fine Sugar]", _treasure_color } },
        { SOT::ActorType::MCH_COMMODITY_TEA_CRATE,          ActorESPInfo{ "[Crate of Rare Tea]", _treasure_color } },
        ...
        { SOT::ActorType::SIREN_GEM_EMERALD,                ActorESPInfo{ "[Emerald Siren Gem]", _treasure_color } },
        { SOT::ActorType::CM_BOUNTY_REWARD_SKULL,           ActorESPInfo{ "[Foul Bounty Skull]", _treasure_color } },
        { SOT::ActorType::BANANA_CRATE,                     ActorESPInfo{ "[Fruit Crate]", _treasure_color } },
        { SOT::ActorType::HIGH_VALUE_GIFT,                  ActorESPInfo{ "[Generous Gift]", _treasure_color } },
        { SOT::ActorType::GOLD_POUCH,                       ActorESPInfo{ "[Gold Pouch]", _treasure_color } },
        { SOT::ActorType::TREASURE_ARTIFACT_BOX_03,         ActorESPInfo{ "[Golden Reliquary]", _treasure_color } },
        { SOT::ActorType::LG_BOUNTY_REWARD_SKULL,           ActorESPInfo{ "[Hateful Bounty Skull]", _treasure_color } },
        { SOT::ActorType::LOW_VALUE_GIFT,                   ActorESPInfo{ "[Humble Gift]", _treasure_color } },
        { SOT::ActorType::LG_TREASURE_CHEST,                ActorESPInfo{ "[Marauder's Chest]", _treasure_color } },
        ...
        { SOT::ActorType::TREASURE_ARTIFACT_VASE_03,        ActorESPInfo{ "[Ornate Carafe]", _treasure_color } },
        ...
        { SOT::ActorType::SIREN_GEM_RUBY,                   ActorESPInfo{ "[Ruby Siren Gem", _treasure_color } },
        ...
        { SOT::ActorType::SIREN_GEM_SAPPHIRE,               ActorESPInfo{ "[Sapphire Siren Gem]", _treasure_color } },
        ...
        { SOT::ActorType::CM_GHOST_BOUNTY_REWARD_SKULL,     ActorESPInfo{ "[Skull of the Damned]", _treasure_color } },
        { SOT::ActorType::TREASURE_CHEST_FORT,              ActorESPInfo{ "[Stronghold Chest]", _treasure_color } },
        { SOT::ActorType::B_GUNPOWDER_BARREL,               ActorESPInfo{ "[Stronghold Gunpowder Barrel]", _treasure_color } },
        { SOT::ActorType::STRONGHOLD_KEY,                   ActorESPInfo{ "[Stronghold Key]", _treasure_color } },
        { SOT::ActorType::FORT_BOUNTY_REWARD_SKULL,         ActorESPInfo{ "[Stronghold Skull]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL1_01,               ActorESPInfo{ "[Tome of Curses I]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL1_02,               ActorESPInfo{ "[Tome of Curses II]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL1_03,               ActorESPInfo{ "[Tome of Curses III]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL1_04,               ActorESPInfo{ "[Tome of Curses IV]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL1_05,               ActorESPInfo{ "[Tome of Curses V]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL3_01,               ActorESPInfo{ "[Tome of Fire I]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL3_02,               ActorESPInfo{ "[Tome of Fire II]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL3_03,               ActorESPInfo{ "[Tome of Fire III]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL3_04,               ActorESPInfo{ "[Tome of Fire IV]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL3_05,               ActorESPInfo{ "[Tome of Fire V]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL4_01,               ActorESPInfo{ "[Tome of Resurrection I]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL4_02,               ActorESPInfo{ "[Tome of Resurrection II]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL4_03,               ActorESPInfo{ "[Tome of Resurrection III]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL4_04,               ActorESPInfo{ "[Tome of Resurrection IV]", _treasure_color } },
        { SOT::ActorType::ASHEN_TOME_VOL4_05,               ActorESPInfo{ "[Tome of Resurrection V]", _treasure_color } },
	...
	const std::unordered_map<SOT::ActorType, const ActorESPInfo> _npc_esp_info
	{
		...
		{ SOT::ActorType::SVN_1,				ActorESPInfo{ "[Cuthbert]", _svn_color } },

		{ SOT::ActorType::GHOST_SHIP_CAPTAIN,	ActorESPInfo{ "[Ferryman]", _special_npc_color } },
	};
