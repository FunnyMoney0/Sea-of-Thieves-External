...
#define EXTERN_OBJECT_CCTOR(class_name) class_name() : ExternalObject() {} class_name(void *instance) : ExternalObject(instance) {}
	...
	* ================================================================
	*/
	class ACannon : public ExternalObject
	{
	public:

		float GetProjectileSpeed() const
		{
			return this->read_member<float>(offsets::ProjectileSpeed);
		}

		float GetProjectileGravityScale() const
		{
			return this->read_member<float>(offsets::ProjectileGravityScale);
		}

		float GetServerPitch() const
		{
			return this->read_member<float>(offsets::ServerPitch);
		}

		float GetServerYaw() const
		{
			return this->read_member<float>(offsets::ServerYaw);
		}
	...
	*/
	...
	class UDrowningComponent : public ExternalObject
	{
	public:
		EXTERN_OBJECT_CCTOR(UDrowningComponent);

			float oxygen_level() const
		{
			return this->read_member<float>(offsets::Oxygen);
		}
	};
	...
	*/
	...
	public:
		...
		UDrowningComponent drowning_component() const
		{
			return this->read_member<UDrowningComponent>(offsets::DrowningComponent);
		}
